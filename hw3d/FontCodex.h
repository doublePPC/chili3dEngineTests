...
{
public:
	static void SetupFont(const std::string& fontName, std::shared_ptr<Surface> fontImage, std::map<unsigned char, std::shared_ptr<Surface>>& charImage, std::map<unsigned char, int>& charData, FontData& fntData)
	{
...
private:
	static void SetupFunky(std::shared_ptr<Surface> fontImage, std::map<unsigned char, std::shared_ptr<Surface>>& charImage, std::map<unsigned char, int>& charData, FontData& fntData)
	{
	...
	static void SetupDefault(std::shared_ptr<Surface> fontImage, std::map<unsigned char, std::shared_ptr<Surface>>& charImage, std::map<unsigned char, int>& charData, FontData& fntData);
public:
